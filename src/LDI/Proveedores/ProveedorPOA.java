...
public abstract class ProveedorPOA extends org.omg.PortableServer.Servant
 implements LDI.Proveedores.ProveedorOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // Proveedores/Proveedor/insertarProveedor
       {
         ...
         $result = this.insertarProveedor (rues, nombre, idDepartamento, idCiudad, direccion, telefono);
         out = $rh.createReply();
       ...
       case 1:  // Proveedores/Proveedor/actualizarProveedor
       {
         ...
         String telefono = in.read_wstring ();
         boolean $result = false;
         $result = this.actualizarProveedor (rues, nombre, idDepartamento, idCiudad, direccion, telefono);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
       ...
       case 2:  // Proveedores/Proveedor/eliminarProveedor
       {
         int rues = in.read_long ();
         boolean $result = false;
         $result = this.eliminarProveedor (rues);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
       ...
       case 3:  // Proveedores/Proveedor/consultarProveedor
       {
         int rues = in.read_long ();
         String $result = null;
         $result = this.consultarProveedor (rues);
         out = $rh.createReply();
  ...
  {
    return (Proveedor) ProveedorHelper.narrow(
    super._this_object());
  }
